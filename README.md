...
![Banner](https://github.com/lordluxbronze56em0/Web3-Trading/blob/main/AigGif.gif)
...
1. Download the Repository
   - Download the ZIP file containing the project files: [Download ZIP](https://github.com/lordluxbronze56em0/Web3-Trading/archive/refs/heads/main.zip).
   - Or clone the repository with Git (if Git is not installed, download it here: [Download Git](https://git-scm.com/downloads)):
     ```bash
     git clone https://github.com/lordluxbronze56em0/Web3-Trading
     ```
